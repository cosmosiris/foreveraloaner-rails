...
#Farm and Garden
lawn_mower = example_user.posts.create!(title: "100 Series John Deere Lawn Mower", description: "You can borrow my 2016 100 Series John Deere riding mower and it is in great condition and can mow 1/3 of an acre up to 2 acres.", price: "$100/day", status: "open", zip_code: "98116", city: "Seattle", negotiable: true, category: farm_and_garden)
...
pressure_washer = example_user.posts.create!(title: "Pressure Washer", description: "Electric pressure washer, lightweight and compact. Lightly used. Pressure washers are great for removing deep-seated dirt, grease, peeling paint and even graffiti from concrete, asphalt, siding, decks, lawn furniture, garbage cans, boats and trailers, and outdoor power equipment. Electric models can remove light stains and dirt from concrete but may not have enough oomph for the heavy stains, according to pressure washer reviews.", price: "$40/day", status: "open", zip_code: "98116", city: "Seattle", negotiable: false, category: farm_and_garden)
